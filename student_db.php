    ...
    <div class="container filter-container">
        <form method="GET">
            <div class="row justify-content-center">
                ...
                <div class="col-md-3">
                    <input type="text" name="searchCategory" class="form-control" placeholder="Search by Category" value="<?php echo isset($_GET['searchCategory']) ? $_GET['searchCategory'] : ''; ?>">
                </div>
                <div class="col-md-2">
...
$sql = "SELECT id,book_name, price, place, book_image, rent_or_sell, user_type FROM selling WHERE user_type = 'student'";
...
<div class="col-md-4">
    <div class="card book-card">
        <img src="data:image/jpeg;base64,' . base64_encode($row['book_image']) . '" alt="Book Image">
        <div class="card-body">
